...
def join(user_df, marketing_df) -> DataFrame:
    # # CROSS JOIN для объединения клиентских данных с маркетинговыми акциями
    # joined = user_df.crossJoin(marketing_df)
    # # Формируем выходное сообщение согласно заданной схеме
    ...
    #     f.substring(f.col("client_id"), 0, 6).alias("client_id"),
